...
object StacksAndQueues {
  ...
  // Problem 3.2: Stack Min: How would you design a stack which, in addition to push and pop,
  ...
  // Problem 3.6: Animal Shelter: An animal shelter, which holds only dogs and cats, operates on a strictly"first in, first out" basis.
