...
object LinkedLists {
  ...
  // Problem  2.3: Delete Middle Node: Implement an algorithm to delete a node in the middle
  ...
  // Problem  2.4: Partition: Write code to partition a linked list around a value x, such that all nodes less than x come before all nodes greater than or equal to x.
  ...
  // Problem  2.7: Intersection: Given two (singly) linked lists, determine if the two lists intersect.
